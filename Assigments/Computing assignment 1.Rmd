...
(b) When the true response rate is 0.25, the stopping rules from part (a) give a ~`r round(sum(B$futility) / N, 2)` probability of stopping for futility (which, in this case, would be the incorrect conclusion). The distribution of stopping times is given in Table 3.
